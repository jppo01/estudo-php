...
<div class="d-flex justify-content-between align-items-center mb-3 no-print">
    ...
    <div class="d-flex gap-2">
        ...
        <a href="<?= base_url('demandas/' . $demand['id'] . '/editar') ?>" class="btn btn-primary btn-sm">
...
<div class="print-title">
    <h2><?= esc($demand['title']) ?> <small class="text-muted">#<?= $demand['id'] ?></small></h2>
    <hr>
</div>
    ...
    <div class="col-md-8">
        <div class="form-card mb-3">
            ...
            <div class="row g-2 mb-3 small">
                <div class="col-6 col-md-3">
                    ...
                    <div><?= priority_badge($demand['priority']) ?></div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="text-muted">Categoria</div>
                    <div><?= esc($demand['category'] ?? '—') ?></div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="text-muted">Responsável</div>
                    <div><?= esc($demand['assignee'] ?? '—') ?></div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="text-muted">Prazo</div>
                    <div><?= date_br($demand['deadline']) ?></div>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div style="white-space:pre-wrap"><?= esc($demand['description']) ?></div>
            </div>
            <?php endif; ?>

            <?php if ($demand['notes']): ?>
            <div class="alert alert-info py-2 small mb-0">
                <i class="bi bi-info-circle me-1"></i><strong>Notas:</strong> <?= esc($demand['notes']) ?>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="form-card mb-3">
            ...
            <div class="d-flex gap-2 mb-3">
                ...
                <div class="flex-1">
                    <div class="fw-semibold small"><?= esc($c['user_name']) ?>
                        <span class="text-muted fw-normal"><?= datetime_br($c['created_at']) ?></span>
                    </div>
                    <div class="small" style="white-space:pre-wrap"><?= esc($c['comment']) ?></div>
                </div>
            </div>
            <?php endforeach; ?>
            <?php else: ?>
        ...
        <div class="form-card mb-3 no-print">
            ...
            <form method="POST" action="<?= base_url('demandas/' . $demand['id'] . '/status') ?>">
                ...
                <textarea name="comment" class="form-control form-control-sm mb-2" rows="2"
                          placeholder="Motivo da mudança (opcional)..."></textarea>
        ...
        <div class="form-card mb-3">
            ...
            <div class="small">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <span><?= esc($demand['created_by_name']) ?></span>
                </div>
                <div class="d-flex justify-content-between mb-2">
                    <span class="text-muted">Criado em</span>
                    <span><?= datetime_br($demand['created_at']) ?></span>
                </div>
                <div class="d-flex justify-content-between">
                    <span class="text-muted">Atualizado</span>
                    <span><?= datetime_br($demand['updated_at']) ?></span>
                </div>
                <?php if ($demand['completed_at'] ?? null): ?>
                <div class="d-flex justify-content-between mt-2">
                    <span class="text-muted">Concluído</span>
                    <span><?= datetime_br($demand['completed_at']) ?></span>
                </div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="timeline">
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-content">
                        ...
                        <?php if ($h['comment']): ?>
                        <div class="small text-secondary fst-italic">"<?= esc($h['comment']) ?>"</div>
                        <?php endif; ?>
