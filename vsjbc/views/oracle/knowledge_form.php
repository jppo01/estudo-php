...
<div class="form-card" style="max-width:700px">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="fw-bold mb-0"><i class="bi bi-robot me-2"></i><?= $pageTitle ?></h5>
        <a href="<?= base_url('oraculo') ?>" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i>Voltar</a>
    </div>
    ...
    <form method="POST" action="<?= $action ?>">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="category" class="form-control"
                       ...
                       placeholder="Ex: Manutenção, Engenharia Clínica, GLPI...">
            </div>
            <div class="col-md-6">
        ...
        <div class="mb-3">
            ...
            <textarea name="answer" class="form-control" rows="6"
                      placeholder="Forneça a resposta..." required><?= esc($entry['answer'] ?? '') ?></textarea>
        </div>
